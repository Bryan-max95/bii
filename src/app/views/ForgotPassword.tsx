    ...
    <div className="min-h-screen flex items-center justify-center bg-[#F7F5F2] p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100 p-8">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-800 tracking-tight">Recuperar Contraseña</h1>
          <p className="text-gray-500 text-sm mt-2">Ingresa tu correo para recibir un enlace de recuperación.</p>
        </div>
